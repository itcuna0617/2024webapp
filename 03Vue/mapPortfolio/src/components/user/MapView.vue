...
const initMap = () => {
  ...
  kakao.maps.load(() => {
    var geocoder = new kakao.maps.services.Geocoder(); // Geocoder 객체를 로드된 후에 초기화
    ...
    kakao.maps.event.addListener(map, "click", function (mouseEvent) {
      ...
      // console.log(new kakao.maps.LatLng(curLat.value, curLng.value).Ma);   // Latitude
      // console.log(new kakao.maps.LatLng(curLat.value, curLng.value).La);   // Longitude
